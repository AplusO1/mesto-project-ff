...
const showInputError = (element, errorElement, errorMessage, validationSettings) => {
...
const isValid = (inputElement, errorElement, validationSettings) => {
  ...
  if (!inputElement.validity.valid) {
    ...
    showInputError(inputElement, errorElement, inputElement.validationMessage, validationSettings);
  } else {
